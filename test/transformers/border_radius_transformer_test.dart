...
void main() {
  test('border radius token - single value', () {
    ...
    expect(transformer.transform(token1.value), equals('const BorderRadius.zero'));
    expect(transformer.transform(token2.value), equals('BorderRadius.circular(16.0)'));
  ...
  test('border radius token - 3 values', () {
    final token1 = Token(value: '0 8px 16px', type: 'borderRadius', name: 'zero', path: '');
    final output =
